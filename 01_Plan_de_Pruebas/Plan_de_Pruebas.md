...
Validar las alertas generadas cuando el inventario alcanza niveles bajos.
Comprobar el proceso de validación de entregas.
Verificar la generación y consulta de reportes de ventas.
...
No se incluyen en este plan funcionalidades que fueron establecidas fuera del alcance inicial del MVP, como pagos en línea, aplicación independiente de domicilios con GPS o programa de fidelización.
...
Procedimiento: 1. Abrir el sistema. 2. Ingresar usuario. 3. Ingresar contraseña. 4. Seleccionar la opción de iniciar sesión.
...
Procedimiento: 1. Abrir el formulario de inicio de sesión. 2. Ingresar usuario. 3. Ingresar contraseña incorrecta. 4. Intentar iniciar sesión.
...
Procedimiento: 1. Ingresar al módulo de usuarios. 2. Crear un usuario de prueba. 3. Asignar un rol. 4. Guardar la información. 5. Modificar los datos del usuario. 6. Verificar los cambios.
...
Procedimiento: 1. Ingresar al módulo de pedidos. 2. Seleccionar los productos solicitados. 3. Registrar la información del pedido. 4. Confirmar el pedido.
...
Procedimiento: 1. Consultar la cantidad disponible de un ingrediente. 2. Registrar un pedido que utilice dicho ingrediente. 3. Confirmar el pedido. 4. Consultar nuevamente el inventario.
...
Procedimiento: 1. Registrar un pedido que reduzca la cantidad disponible. 2. Verificar el nivel de inventario. 3. Compararlo con el nivel mínimo establecido.
...
Procedimiento: 1. Consultar el pedido pendiente. 2. Verificar la información de la entrega. 3. Registrar la validación. 4. Confirmar el proceso.
...
Objetivo: Verificar que un usuario autorizado pueda consultar los reportes de ventas.
Precondición: Deben existir registros de ventas.
Procedimiento: 1. Iniciar sesión con un usuario autorizado. 2. Ingresar al módulo de reportes. 3. Seleccionar el reporte de ventas. 4. Consultar la información.
...
Procedimiento: 1. Iniciar sesión con un usuario de prueba. 2. Intentar acceder a una funcionalidad restringida. 3. Verificar la respuesta del sistema.
...
Procedimiento simulado: 1. Simular múltiples solicitudes de consulta y registro. 2. Observar el comportamiento del sistema. 3. Verificar la disponibilidad de los módulos principales.
...
CP-01	Inicio de sesión exitoso	      Funcionó correctamente	Aprobado
...
1.	Pantalla de inicio de sesión exitoso.
...
Los casos definidos abarcan aspectos relacionados con autenticación, permisos, pedidos, inventario, entregas y reportes, además de pruebas unitarias, de integración, estrés y aceptación.
