...
El sistema permite gestionar pedidos, controlar el inventario de ingredientes, administrar usuarios y roles, validar entregas y consultar informes de ventas.
...
Los usuarios del sistema PizzaExpress contemplan diferentes tipos de usuarios:
...
* Una computadora o dispositivo con acceso al sistema.
...
Esta es una de las principales funcionalidades de PizzaExpress.
...
Los informes pueden incluir información como:
...
Los informes sirven como apoyo para el análisis y la toma de decisiones del negocio.
...
* Consultar los informes de ventas para realizar seguimiento al negocio.
...
Si el problema continúa, solicite apoyo al administrador.
...
Verifique los últimos movimientos registrados y revise las cantidades ingresadas.

### No aparece un pedido

Verifique que el pedido haya sido guardado y confirmado correctamente.
